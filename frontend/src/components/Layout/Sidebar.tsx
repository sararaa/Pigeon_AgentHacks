...
interface SidebarProps {
  ...
  currentView: 'map' | 'analytics' | 'quick-access';
}

const Sidebar: React.FC<SidebarProps> = ({ isOpen, onToggle, setCurrentView, currentView }) => {
        ...
        >
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              {/* Map Views Section - Only visible in map view */}
              {currentView === 'map' && (
                <div className="p-4 border-b border-gray-200 dark:border-gray-700">
              ...
              {/* Map Layers Section - Only visible in map view */}
              {currentView === 'map' && (
                <div className="p-4">
                    ...
                    {mapLayers.map((layer) => (
                      ...
                      >
                        <span className="flex items-center gap-2">
                          {layer.id === 'traffic' && <MapIcon className="h-5 w-5" />}
                          {layer.id === 'parking' && <BarChart2 className="h-5 w-5" />}
                          {layer.id === 'projects' && <Settings className="h-5 w-5" />}
                          {layer.name}
                        </span>
                        {layer.isVisible ? (
